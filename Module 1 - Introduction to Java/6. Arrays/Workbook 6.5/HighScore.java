public class HighScore {
    public static void main(String[] args) {
         ...
         * 32863 23707
         */
        int[] ranNums = { randomNumber(), randomNumber(),randomNumber(), randomNumber(), randomNumber(), randomNumber(), randomNumber(), randomNumber(), randomNumber(), randomNumber() };
